...
fn print_stack_data(buf1: &[u8; BUFSIZE], buf2: &[u8; BUFSIZE]) {
    ...
    println!("Stack Data 1: {:?}, Memory Address: {:?}", buf1_str, buf1.as_ptr());
    println!("Stack Data 2: {:?}, Memory Address: {:?}", buf2_str, buf2.as_ptr());
}

pub fn stack_test(arg: &str) {
    println!("arg: {}", arg);
